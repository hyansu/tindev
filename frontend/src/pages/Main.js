...
import buttonLike from '../assets/like.svg'
import buttonDislike from '../assets/dislike.svg'
...
export default function Main({match}){
    ...
    useEffect(() => {
        ...
        async function loadUsers(){
            const result = await api.get('/devs', {headers: {user: match.params.id}})
